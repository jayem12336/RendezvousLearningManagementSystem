...
export default function ClassQuiz() {
  ...
  return (
    <Teacherdrawer headTitle='Create Exam' classCode={params.id} loading={loading}>
      ...
      <Box component={Grid} container justifyContent="center" sx={{ paddingTop: 5, paddingBottom: 2 }}>
        ...
        <Grid container sx={style.addBtncontainer} justifyContent='space-between'>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Grid container justifyContent="flex-end">
              <Button variant="contained" style={{ width: 130, height: 38, marginLeft: 2, fontWeight: 'bold' }} onClick={saveQuiz}>Create Exam</Button>
